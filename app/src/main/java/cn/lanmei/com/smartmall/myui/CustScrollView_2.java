...
public class CustScrollView_2 extends ScrollView {
	boolean allowDragTop = true; // 如果是true，则允许拖动至底部的下一页
	float downY = 0;
	boolean needConsumeTouch = true; // 是否需要承包touch事件，needConsumeTouch一旦被定性，则不会更改

	public CustScrollView_2(Context arg0) {
		this(arg0, null);
	}

	public CustScrollView_2(Context arg0, AttributeSet arg1) {
		this(arg0, arg1, 0);
	}

	public CustScrollView_2(Context arg0, AttributeSet arg1, int arg2) {
