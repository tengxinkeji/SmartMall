...
import cn.lanmei.com.smartmall.adapter.AdapterIcon;
 ...
 */
public class
F_index_recommend extends BaseScrollFragment {
    ...
    public void init(){
        ...
        adapterImg=new AdapterImg_1(mContext,cateRe);
        ads=new ArrayList<>();
        adsRe=new ArrayList<>();

        categroys=new ArrayList<>();
        categroys=dbManagerCategory.getCategroysRec();
        int width=res.getDimensionPixelSize(R.dimen.img_category_width);
        adapterIcon=new AdapterIcon(mContext,categroys,StaticMethod.dip2px(mContext,width));
    ...
    public void findViewById() {
        ...
        mGridView_Cate.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent toList=new Intent(getActivity(), Activity_list_goods.class);
                ...
                toList.putExtra(Common.KEY_bundle,data);
