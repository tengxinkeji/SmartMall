...
public class OrderInfoUtil2_0 {
	 ...
	 * @return
	 */
	public static Map<String, String> buildOrderParamMap(String app_id,String notify_url,double money,String orderNo) {
		Map<String, String> keyValues = new HashMap<String, String>();
...
//		keyValues.put("timestamp", "2016-07-29 16:55:53");
		...
		keyValues.put("timestamp", StaticMethod.formatterTime(System.currentTimeMillis()));
