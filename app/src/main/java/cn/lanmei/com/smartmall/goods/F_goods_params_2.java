...
public class F_goods_params_2 extends Fragment {
    ...
    public static F_goods_params_2 newInstance(int goodsId) {
        F_goods_params_2 fragment = new F_goods_params_2();
        ...
        switch (position){
            case 0:
                ...
                if (goodsParamsDetail==null)
                    goodsParamsDetail=F_goods_params_detail_2.newInstance(goodsId);
            ...
            case 1:
                ...
                txtGoodsServer.setTextColor(ContextCompat.getColor(getActivity(),R.color.txtColor_txt));
                if (goodsParamsParams==null){
                    goodsParamsParams=F_goods_params_params_2.newInstance(goodsId);
            ...
            case 2:
                ...
                if (goodsParamsServer==null){
                    goodsParamsServer=F_goods_params_server_2.newInstance(goodsId);
