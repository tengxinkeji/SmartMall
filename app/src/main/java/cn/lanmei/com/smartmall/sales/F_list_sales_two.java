 ...
 *
 */
public class F_list_sales_two extends BaseScrollFragment {

    private String TAG="F_list_sales_two";
    ...
    public static F_list_sales_two newInstance() {
        F_list_sales_two f=new F_list_sales_two();
        return f;
    }
    ...
    public  void init(){
        ...
        adapterSales=new AdapterSales(mContext,mUsers,2);
