...
public class Activity_complete_info extends BaseActionActivity {
    public static final int SDK_PERMISSION_REQUEST = 127;
    private String permissionInfo;
    F_complete_info fCompleteInfo;
    ...
    public void loadViewLayout() {
        fCompleteInfo=F_complete_info.newInstance();
        setMContentView(fCompleteInfo);
    }
