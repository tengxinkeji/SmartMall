...
public class SeekCircle extends ProgressCircle
{
	...
	public interface OnSeekCircleChangeListener
	{
		 ...
		 *            The SeekCircle in which the touch gesture began
		 */
		boolean onStopTrackingTouch(SeekCircle seekCircle, boolean updateProgress);
	}
	...
	public boolean onTouchEvent(MotionEvent event)
	{
		...
		float x =mCenterX-event.getX();
		float y =event.getY()- mCenterY ;
		
		float distance = (float) Math.sqrt(x * x + y * y);
		
		boolean inRange = Math.abs(distance - mmRadius) <= mSectionHeight;
...
//					SystemConst.seekCiecleFirst = true;
			...
			case MotionEvent.ACTION_UP:
				...
				if (mOnSeekCircleChangeListener != null)
					updateProgress=mOnSeekCircleChangeListener.onStopTrackingTouch(this,updateProgress);
...
//				SystemConst.seekCiecleFirst = false;
				mTrackingTouch = false;
				if (mOnSeekCircleChangeListener != null)
					mOnSeekCircleChangeListener.onStopTrackingTouch(this,updateProgress);
