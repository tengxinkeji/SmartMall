...
public class EsptouchTaskParameter implements IEsptouchTaskParameter {
	...
	private long mIntervalScanWifiisecond;
	...
	public EsptouchTaskParameter() {
		...
		mIntervalScanWifiisecond=20000;
		...
		mTargetPort = 7001;
		mWaitUdpReceivingMilliseond = 60000;
	...
	@Override
	public long getmIntervalScanWifiisecond() {
		return mIntervalScanWifiisecond;
	}
